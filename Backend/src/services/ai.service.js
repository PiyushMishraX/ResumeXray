...
async function generatePdfFromHtml(htmlContent) {
    ...
    // await page.emulateMediaType('screen'); // to create A4 size
    const pdfBuffer = await page.pdf({ 
        format: "A4", margin: { // use ctrl + space to find realted properties // and ctrl click to read its doc or ctrl click to see more info
            top: "20mm",
            bottom: "20mm",
            left: "15mm",
            right: "15mm"
...
async function generateResumePdf({resume, selfDescription, jobDescription}) {
    ...
    const prompt = `Generate a resume for a candidate with the following details:
                        ...
                        The resume should be tailored for the given job description and should highlight the candidate's strengths and relavent experience. The HTML content should be well-formatted and structured, making it easy to read and visually appealing.
                        The content of resume should not be sounded like it's generated by AI and should be as cose as possible to a real human-written resume.
                        you can highlight the content using some colors or different font styles but the overall design should be simple and professional.
                        The content should be ATS friendly, i.e. it should be easily parsable by ATS systems without losing important information.
                        The resume should not be so lengthy, it should ideally be 1-2 pages long when converted to PDF. Focus on quality rather than quantity and make sure to include all the relevant information that can increase the candidates's chances of gettingan interview call for the given job description.
                    `
